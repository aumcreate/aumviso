...
/**
 * Plugin Name: AumViso – AI SEO & GEO: Schema, Sitemaps & Internal Links
 * Description: AumViso — SEO + GEO all-in-one: meta tags, Schema, sitemaps, internal links, FAQ/Glossary/Guide content types, AI tools, knowledge building, automation and llms.txt.
 * Version:     2.0.7
 * Author:      AumCreate
